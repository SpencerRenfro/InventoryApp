...
function App() {
  ...
  return (
    <div className='dark:bg-slate-900 min-h-screen '>
      <Navbar />
      <Routes>
        <Route path="/" element={<Inventory setShowModal={setShowModal} categoryFilter={filter}/>} />
        ...
        <Route path="/item-creation-successful" element={<ItemCreationSuccessful />} />
        <Route path="/item-creation-failure" element={<ItemCreationFailure />} />
      </Routes>
      {showModal && (
